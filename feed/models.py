...
class User(models.Model):
    ...
    pfp = models.ImageField(upload_to=None, height_field=None, width_field=None, max_length=100)



# Users can have many posts (one to many relationship)
class Posts(models.Model):
    postImage = models.ImageField(upload_to=None, height_field=None, width_field=None, max_length=100)
...
class Comments(models.Model):
    ...
    commentsPost = models.ForeignKey(User, on_delete=models.CASCADE)
    # comment's user
